...
SELECT first_name, last_name, home_phone -- запрос изменил под скриншот. Порядок вывода в задании: фамилия, имя, телефон. Порядок вывода на скриншоте: имя, фамилия, телефон
FROM employees
